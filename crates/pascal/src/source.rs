...
pub fn generated_preamble(src: &mut Source, version: &str) {
    ...
    uwriteln!(src, "");
    uwriteln!(src, "{{ The file was generated using this `wit-bindgen` fork, which implements Pascal");
    uwriteln!(src, "  support:");
    uwriteln!(src, "");
    uwriteln!(src, "    https://github.com/nickysn/wit-bindgen/tree/pascal");
    uwriteln!(src, "");
    uwriteln!(src, "  It is currently under heavy development.");
    uwriteln!(src, "}}");
    uwriteln!(src, "");
}
